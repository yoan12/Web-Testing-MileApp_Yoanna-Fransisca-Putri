...
WebUI.setText(findTestObject('Page_Mileapp  Request Demo/Page_Mileapp  Request Demo/input_Email_email'), 'yoannafransisca@gmail.com')

WebUI.click(findTestObject('Page_Mileapp  Request Demo/input_Phone number_phone'))

WebUI.setText(findTestObject('Page_Mileapp  Request Demo/input_Phone number_phone'), '081234567889')
...
WebUI.waitForElementPresent(findTestObject('Page_Mileapp  Request Demo/div_The full name field is required'), 0)
