...
WebUI.setText(findTestObject('Page_Mileapp  Request Demo/Page_Mileapp  Request Demo/input_Email_email'), '')
...
WebUI.waitForElementPresent(findTestObject('Page_Mileapp  Request Demo/div_The email field is required'), 5)
